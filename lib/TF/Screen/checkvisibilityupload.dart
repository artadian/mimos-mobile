...
import 'package:mimos/TF/Bloc/visibilitynotuploadbloc.dart';
...
class CheckVisibilityUpload extends StatefulWidget {
  @override
  _CheckVisibilityUploadState createState() => _CheckVisibilityUploadState();
}

class _CheckVisibilityUploadState extends State<CheckVisibilityUpload> {
 ...
 Future<void> _dialogCall(
    ...
    return Alert(
      ...
      title: "Upload Ulang",
      desc: "Visibility '" + customerName + "' to Server ",
      buttons: [
        DialogButton(
          child: Text(
            "CANCEL",
        ...
        DialogButton(
          ...
          onPressed: () {
            ...
            Navigator.pop(context);
             _visibilityNotUploadBloc.getPosmNotUploadByMaterialID();
          },
 ...
 // final oCcy = new NumberFormat("#,##0.00", "en_US");
  VisibilityNotUploadBloc _visibilityNotUploadBloc = VisibilityNotUploadBloc();
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        backgroundColor: Color(0xFF54C5F8),
        title: Text("Upload Ulang Cek Display"),
  ...
  _updateGetIDRestServerDetailStock(trxid, getid) async {
    ...
    var strSQL;
    strSQL =
        " UPDATE visibility set getidvisibilitydetail = '" + getid.toString() + "' ";
...
//----- end upload posm
  Widget getPosmWidget() {
    ...
    */
    return StreamBuilder(
      ...
      stream: _visibilityNotUploadBloc.posmNotUploadByMaterialID,
      builder:
  ...
  Widget loadingData() {
    //pull todos again
    _visibilityNotUploadBloc.getDataPOSMNotUploadByMaterialID();
    return Container(
      child: Center(
        child: Column(
          mainAxisAlignment: MainAxisAlignment.center,
