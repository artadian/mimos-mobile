...
class VisibilityModel {
  ...
  VisibilityModel.createFromJson(Map<String, dynamic> map)
      : this.id = null,
        this.userid = session.userId(),
        this.customerno = map["customerno"].toString().clean(),
        this.visibilitydate = map["tanggalkunjungan"].toString().clean(),
  ...
  Map<String, dynamic> toJson() {
    ...
    data['visibilitydate'] = this.visibilitydate;
