...
class DownloadPRVM with ChangeNotifier {
  ...
  downloadVisit() async {
    ...
    if (resVisit.status) {
      ...
      _visitDao.truncate();
      _visitDao.insertAll(resVisit.list);
    } else {
      print(resVisit.message);
    }
    ...
    if (resVisit.status) {
      print(resVisit.message);
      _stockDao.truncate();
      _stockDao.insertAll(resStock.list);
    } else {
      print(resVisit.message);
    }
    // STOCK DETAIL
    ...
    if (resVisit.status) {
      ...
      _stockDetailDao.insertAll(resStockDetail.list);
    } else {
      print(resVisit.message);
    }
    ...
    if (resVisit.status) {
      print(resVisit.message);
      _sellinDao.truncate();
      _sellinDao.insertAll(resSellin.list);
    } else {
      print(resVisit.message);
    }
    // SELLIN DETAIL
    ...
    if (resVisit.status) {
      ...
      _sellinDetailDao.insertAll(resSellinDetail.list);
    } else {
      print(resVisit.message);
    }
